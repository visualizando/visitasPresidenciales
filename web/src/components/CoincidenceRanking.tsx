...
function coincidenceSummary(overlaps: number, automatic: number, showSelected: boolean) {
  const automaticLabel = `${automatic.toLocaleString("es-AR")} ${automatic === 1 ? "coincidencia automática" : "coincidencias automáticas"}`;
